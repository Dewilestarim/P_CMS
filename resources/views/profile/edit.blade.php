    ...
    <form enctype="multipart/form-data" action="{{ route('admin.profile.update', $profile->id) }}" method="POST">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <textarea id="desc" class="form-control" name="desc" data-placeholder="Masukkan deskripsi disini" required>{{ $profile->desc }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea id="address" class="form-control" name="address" data-placeholder="Masukkan alamat disini" required>{{ $profile->address }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea id="vision" class="form-control" name="vision" data-placeholder="Masukkan deskripsi disini" required>{{ $profile->vision }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea id="mission" class="form-control" name="mission" data-placeholder="Masukkan deskripsi disini" required>{{ $profile->mission }}</textarea>
